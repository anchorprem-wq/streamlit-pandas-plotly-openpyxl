...
try:
    ...
    st.write(f"Loaded file: activity_data.xlsx")
...
df_long = df.melt(id_vars=["Activity", "Summary", "Target", "Sample"], 
...
# Dependent Summary Dropdown (dynamic update)
